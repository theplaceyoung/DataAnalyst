...
pop65 <- read.csv(file = "/Users/jangsoyoung/Documents/source codes/Spatio-Temporal-Crime-Analysis-Time-Series-NYC-master/R_Correlations_Demographics_Crime/borough-populationaged65.csv", header = TRUE, sep=",")
pop65
totalpop <- read.csv(file = "/Users/jangsoyoung/Documents/source codes/Spatio-Temporal-Crime-Analysis-Time-Series-NYC-master/R_Correlations_Demographics_Crime/borough-population.csv", header = TRUE, sep=",")
...
# pop65 <- pop65 %>% + slice(match(x, Borough)) 
# pop65

# totalpop <- totalpop 
#  + slice(match(x, Borough)) # %>% + slice(match(x, Borough)) 
# totalpop
...
total_num_crime <- read.csv(file = "/Users/jangsoyoung/Documents/source codes/Spatio-Temporal-Crime-Analysis-Time-Series-NYC-master/R_Correlations_Demographics_Crime/final.csv", header = TRUE, sep=",")
